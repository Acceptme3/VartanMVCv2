        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorksCategoryID = table.Column<int>(type: "int", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TitleImagePath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MetaTitle = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MetaDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "9690ccb5-3b89-457b-a2ee-b7dfab3526a0", 0, "5fd8d7d1-038e-4e3c-a3c9-e265baa85e76", "my@email.com", true, false, null, "MY@EMAIL.COM", "ADMIN", "AQAAAAIAAYagAAAAEKam3lx8SN47lng9tMOGtURLhmtZiu1d9ibqehvQLZ6lWZbs3C/DTqmOA2MRU4Wj1Q==", null, false, "", false, "admin" });

            migrationBuilder.InsertData(
                table: "WorkServices",
                columns: new[] { "ID", "Описание услуги", "MetaDescription", "MetaKeywords", "MetaTitle", "Заголовок услуги", "Путь к файлу изображения" },
                values: new object[] { 1, "Разработка индивидуального дизайн-проекта.", null, null, null, "Дизайн-проект", "/images/img-2.png" });
