...
namespace VartanMVCv2.Migrations
{
    ...
    [Migration("20231022121107__init")]
    partial class _init
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "00187353-043c-41db-bf46-12fa223f8f48",
                            Email = "my@email.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "MY@EMAIL.COM",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAEKytfDJq+jX6sj7OFdeoU3EPj8Hrn6bgmWRm29vhIg18hXkfs9U7ZZNbwMurCiEzSg==",
            ...
            modelBuilder.Entity("VartanMVCv2.Domain.Entities.CompletedProject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("7b9d43d6-09b7-4008-a465-26e27ebc142c"),
                            Title = "Ремонт ванной 6 кв.м",
                            TitleImagePath = "/images/img-5.png"
                        },
                        new
                        {
                            ID = new Guid("45ed188f-602b-44f7-bc91-012f9d2581dd"),
            ...
            modelBuilder.Entity("VartanMVCv2.Domain.Entities.Feedback", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("d2d01721-dbac-4d5a-9e2e-6ebe2a432d61"),
                            ...
                            registrationDate = new DateTime(2023, 10, 22, 15, 11, 7, 159, DateTimeKind.Local).AddTicks(482)
                        },
                        new
                        {
                            ID = new Guid("acd7dc13-7927-47f3-ad2a-8c43a17fdc19"),
                            ...
                            registrationDate = new DateTime(2023, 10, 22, 15, 11, 7, 159, DateTimeKind.Local).AddTicks(508)
                        });
                });

            modelBuilder.Entity("VartanMVCv2.Domain.Entities.Work", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VartanMVCv2.Domain.Entities.WorkServices", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("6d8d208c-205a-4f2f-ba9c-2e517ac856b2"),
            ...
            modelBuilder.Entity("VartanMVCv2.Domain.Entities.WorksCategory", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("WorkServicesID")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("ID");

                    b.HasIndex("WorkServicesID");
            ...
            modelBuilder.Entity("VartanMVCv2.Domain.Entities.Work", b =>
                {
                    b.HasOne("VartanMVCv2.Domain.Entities.WorksCategory", "WorksCategory")
                        .WithMany("Works")
            ...
            modelBuilder.Entity("VartanMVCv2.Domain.Entities.WorksCategory", b =>
                {
                    b.HasOne("VartanMVCv2.Domain.Entities.WorkServices", "Services")
                        .WithMany("WorksCategories")
                        .HasForeignKey("WorkServicesID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
